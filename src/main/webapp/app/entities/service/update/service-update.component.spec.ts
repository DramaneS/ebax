...
describe('Service Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Entreprise query and add missing value', () => {
      ...
      const entreprise: IEntreprise = { id: 2161 };
      service.entreprise = entreprise;

      const entrepriseCollection: IEntreprise[] = [{ id: 22254 }];
    ...
    it('Should call Project query and add missing value', () => {
      const service: IService = { id: 456 };
      const projects: IProject[] = [{ id: 11455 }];
      service.projects = projects;

      const projectCollection: IProject[] = [{ id: 19977 }];
    ...
    it('Should update editForm', () => {
      const service: IService = { id: 456 };
      const entreprise: IEntreprise = { id: 15216 };
      service.entreprise = entreprise;
      const project: IProject = { id: 16978 };
